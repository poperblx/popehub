...
local AutoOpenChest = loadstring(game:HttpGet(('https://raw.githubusercontent.com/poperblx/popehub/main/AnimeChampionSimulator/AutoOpenChest.lua')))();
local AutoRaid = loadstring(game:HttpGet(('https://raw.githubusercontent.com/poperblx/popehub/main/AnimeChampionSimulator/AutoRaid.lua')))();
local funcName = "attempt_open_chest";
local currentEnemy = nil;
local AnimeChampionSimulator = {};
...
function AnimeChampionSimulator.init()
    AutoOpenChest.init();
end

return AnimeChampionSimulator;